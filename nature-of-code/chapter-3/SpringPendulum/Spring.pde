...
//         anchor = new PVector(x, y); // anchor point
//         len = l; // rest length
//     }

//     void connect(Bob b) {
//         PVector force = PVector.sub(b.location, anchor);
//         float d = force.mag(); // distance of stretched spring
//         float displacement = d - len; // calculate displacement

//         force.normalize();
//         force.mul(-1 * k * displacement); // Hooke's law

//         b.applyForce(force); // Apply force to the bob
//     }
